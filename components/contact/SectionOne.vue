        ...
        <div class="my_container">
            <div class="w-full mb-40 lg:mb-60 xl:mb-80">
                ...
                <div class="flex flex-wrap items-center gap-y-20 gap-x-24 lg:ga-xp-32 xl:gap-x-40">
                    <div class="flex items-center gap-12">
                        ...
                        <p class="text-20 lg:text-24 xl:text-28 font-interfaces_500">город Ташкент Мирзо-Улугбекский район, дом 100, 700124</p>
                    </div>
                    <a href="tel:+998909992222" class="flex items-center gap-12">
                        ...
                        <p class="text-20 lg:text-24 xl:text-28 font-interfaces_500">+998 (90) 999-22-22</p>
                    </a>
                    <a href="mailto:support@tour.uz" class="flex items-center gap-12">
                        ...
                        <p class="text-20 lg:text-24 xl:text-28 font-interfaces_500">support@tour.uz</p>
                    </a>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-32 lg:gap-46 xl:gap-56 2xl:gap-72 border border-grey_8 px-24 py-16 md:px-36 md:py-24 xl:px-64 xl:py-36 2xl:px-80 2xl:py-56">
                <form @submit.prevent="onSubmit()">
                    <h4 class="text-24 md:text-28 lg:text-32 xl:text-36 2xl:text-40 font-prosto_one mb-24 lg:mb-40 leading-100">Остались вопросы?</h4>
                    ...
                    <div class="grid xl:grid-cols-2 gap-x-16 gap-y-24 2xl:gap-y-32">
                        <div class="w-full relative">
                            ...
                            <label class="base_label font-inter" for="firstname">Имя *</label>
                        ...
                        <div class="w-full relative">
                            ...
                            <label class="base_label font-inter" for="lastname">Фамилия *</label>
                        </div>
                        <div class="w-full relative">
                            <input type="email" v-model="email" class="base_input font-inter" name="email" id="email" required />
                            <label class="base_label font-inter" for="email">Электронная почта *</label>
                        </div>
                        <div class="w-full relative">
                        ...
                        <p class="lg:col-span-2 text-14 lg:text-16 font-inter text-grey_40">Нажав кнопку "Отправить", вы подтверждаете, что даете компании свое согласие на обработку ваших персональных данных</p>
                    </div>
                </form>
